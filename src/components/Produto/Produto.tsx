  ...
  const produtosEspeciais = [
    {
      id: "espresso",
      name: "Espresso",
      description: "Dose intensa e rica, perfeita para um sabor concentrado.",
      price: 8.0,
      img: Espresso,
    },
    {
      id: "cappuccino",
      name: "Cappuccino",
      description: "Café expresso com leite cremoso e espuma leve.",
      price: 12.0,
      img: Cappuccino,
    },
    {
      id: "mocha",
      name: "Mocha",
      description: "Mistura de café e chocolate, coberto com chantilly.",
      price: 14.0,
      img: Mocha,
    },
    {
      ...
      description: "Café suave com um toque doce.",
      price: 8.0,
      img: Aromatizado,
    },
  ];
  ...
  const produtosArtesanais = [
    {
      id: "cha_preto",
      name: "Chá Preto",
      description: "Sabor robusto e encorpado, ideal para qualquer hora.",
      price: 6.0,
      img: ChaPreto,
    },
    {
      id: "cha_verde",
      name: "Chá Verde",
      description: "Leve e refrescante, cheio de antioxidantes.",
      price: 12.0,
      img: ChaVerde,
    },
    {
    ...
    },
    {
      ...
      description: "Combinação frutada e deliciosa, ótima quente ou gelada.",
      price: 8.0,
      img: ChaMorango,
    },
  ];
  ...
  const produtosLanches = [
    {
      id: "pao_de_queijo",
      name: "Pão de Queijo",
      description: "Crocante por fora, macio e saboroso por dentro.",
      price: 5.0,
      img: PaoDeQueijo,
    },
    {
      id: "croissant",
      name: "Croissant",
      description: "Massa folhada com recheio delicioso.",
      price: 9.0,
      img: Croissant,
    },
    {
    ...
    },
    {
      id: "torta",
      name: "Torta de Limão",
      description: "Deliciosa e azedinha, com massa crocante e creme leve.",
      price: 10.0,
      img: Torta,
    },
  ];
          ...
          <Shape key={produto.id}>
            ...
            <img
              className={
                produto.id === "bolo"
                  ? "Bolo"
                  : produto.id === "cha_gelado"
                  ? "ChaGelado"
                  : produto.id === "cha_morango"
                  ? "Morango"
                  : ""
              }
              src={produto.img}
